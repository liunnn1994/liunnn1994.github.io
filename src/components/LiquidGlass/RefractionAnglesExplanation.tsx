...
import { getRayColorDimmed } from "./rayColor";
      ...
      <div className="relative select-none">
        ...
        >
          ...
          <motion.line
            ...
            className="stroke-blue-500 dark:stroke-blue-600 opacity-70"
            strokeWidth={1}
            strokeDasharray={2}
          />
        </motion.svg>
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none text-[11px] sm:text-[13px] [line-height:1.2] text-slate-500 dark:text-slate-500">
          ...
          <div className="absolute right-[calc(50%+2px)] top-6 text-right -rotate-90">
            正
          </div>
        </div>
      </div>
