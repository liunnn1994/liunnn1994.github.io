...
export const Searchbox: React.FC = () => {
  ...
  const containerStyle: React.CSSProperties = useImageBg
    ? {
        backgroundImage:
          'url("https://plus.unsplash.com/premium_photo-1676218966210-298056b2b978?q=80&w=1223&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
